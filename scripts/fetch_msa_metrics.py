...
ROLLUP_METRICS = [
    ...
    (_M("net_migration_per_1k", "Net migration / 1k", "/1k", "good_high", "Growth", "IRS SOI", "num2"),
        ("__net_rate__",)),
    (_M("cycle_index", "Business-cycle index", "idx", "good_high", "Growth", "Georgia Economics (BLS CES+LAUS)", "num1"),
        ("business_cycle_index", "latest_value")),
    (_M("forecast_gmp_yoy", "Forecast GDP growth", "% next yr", "good_high", "Growth", "Georgia Economics forecast", "pct1"),
    ...
    # Housing
    (_M("price_to_income", "Price-to-income", "x", "good_low", "Housing", "Georgia Economics valuation", "num1"),
        ("housing_valuation", "price_to_income_ratio")),
    (_M("valuation_pct", "Home over/under-valuation", "%", "good_low", "Housing", "Georgia Economics valuation", "pct1"),
        ("housing_valuation", "latest_valuation_pct")),
    (_M("affordability_index", "Buyer affordability", "idx", "good_high", "Housing", "Georgia Economics (NAR-style)", "num1"),
    ...
    (_M("quality_of_life", "Quality of life", "idx", "good_high", "Quality of life", "Georgia Economics composite", "num0"),
        ("quality_of_life", "value")),
    (_M("vitality", "Economic vitality", "0-1", "good_high", "Quality of life", "Georgia Economics composite", "num2"),
        ("vitality", "value")),
    ...
    (_M("cost_of_living_index", "Cost of living (US=100)", "idx", "good_low", "Business", "Georgia Economics (BEA RPP logic)", "num0"),
        ("business_costs", "cost_of_living_index")),
    (_M("business_cost_index", "Business costs (US=100)", "idx", "good_low", "Business", "Georgia Economics composite", "num0"),
        ("business_costs", "business_cost_index")),
    (_M("industrial_diversity", "Industrial diversity", "0-1", "good_high", "Business", "Georgia Economics Hachman", "num2"),
        ("industrial_diversity", "score")),
    (_M("credit_score", "Metro credit score", "0-100", "good_high", "Business", "Georgia Economics composite", "num0"),
        ("credit_score", "score")),
]
